			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<ul class="nav nav-pills">
						...
						<li class="active"><a data-toggle="pill" href="#menu1">Cheque</a></li>
					...
					<div class="tab-content">
						<div id="home" class="tab-pane fade">
							...
							<form class="form" onsubmit="this.preventDefault();">
								...
								<div class="form-group">
									<label>*Amount</label>
									<input type = "number" name="amo" id="amo" class="form-control col-sm-2" style="text-align: right" required>
								</div>
								<div class="form-group">
									<label for="remarks">Remarks:</label>
									<textarea class="form-control" rows="3" id="remarks" name="remarks"></textarea>
								</div>
								<button class="btn btn-primary finalize-payment">Save</button>
							</form>
						</div>
						<div id="menu1" class="tab-pane fade in active">
							...
							<form class="form">
								...
								<div class="form-group">
									...
									&nbsp;&nbsp;<input type="text" id="chqNo" class="form-control" value="{{ $cheques[0]->chequeNumber }}">
								</div>
								<div class="form-group">
									<label for="bank">*Bank Name: &nbsp;</label>
									&nbsp;&nbsp;<input type="text" id="bank" class="form-control" value="{{ $cheques[0]->bankName }}">
								</div>
								<div class="form-group">
