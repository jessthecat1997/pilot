	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="panel panel-primary">
				...
				@else
				<div class="panel panel-primary">
					<div class="panel-heading">Refundables</div>
					<button type="button" class="btn but pull-right addBill" data-toggle="modal" data-target="#revModal">Add Bills</button>
					<div class = "panel-body">
						@if(count($exp_bill) > 0)
						<table class="table table-hover" id="revenue_table">
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align: right;">
										<h5><strong>Php {{ $exp_sub[0]->Total }}</strong></h5>
									</td>
								</tr>
								<tr>
									<td style="text-align: right;">
									...
									<td style="text-align: right;">
										<h5><strong>Php {{ $exp_vat[0]->Total }}</strong></h5>
									</td>
								</tr>
								<tr>
									<td style="text-align: right;">
									...
									<td style="text-align: right;">
										<h4><strong><u>Php {{ $exp_total[0]->Total }}</u></strong></h4>
									</td>
								</tr>
								<tr>
									<td colspan="2">
