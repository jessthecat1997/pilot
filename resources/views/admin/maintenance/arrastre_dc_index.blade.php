	...
	$(document).ready(function(){
		...
		$(document).on('click', '.new', function(e){
			...
			for(var i = 0; i < arr_container_size_id.length; i++){
				...
				rows += '<tr id = "af-row"><td><div class = "form-group input-group" ><input type = "text" class = "form-control  af_container_size_valid" value ="" name = "container_size" id = "container_size"  data-rule-required="true" disabled style="text-align: right;"/><span class = "input-group-addon">-footer</span> </div></td><td><div class = "form-group input-group"  ><select name = "dc_types" id = "dc_types" class = "form-control select2-allow-clear dc_types" style="width: 100%;" multiple="multiple"></select></div></td><td><div class = "form-group input-group " ><span class = "input-group-addon">Php</span><input type = "text" class = "form-control money amount_valid" value ="0.00" name = "amount" id = "amount"  data-rule-required="true"  style="text-align: right;"/></div></td></tr>';
