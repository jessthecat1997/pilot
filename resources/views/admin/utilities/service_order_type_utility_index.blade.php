...
<div class = "container-fluid">
	<div class = "row">
		<h3><img src="/images/bar.png"> Utilities | Archive | Service Order Type</h3>
		<hr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var sotable = $('#sotype_table').DataTable({
			processing: true,
			serverSide: true,
			ajax: 'http://localhost:8000/utilities/service_order_type_deactivated/' + filter,
			columns: [
			{ data: 'id' },
			{ data: 'description' },
			{ data: 'created_at'},
...
$('#btnActivate').on('click', function(e){
	...
	$.ajax({
		type: 'PUT',
		url:  '/utilities/service_order_type_reactivate/' + data.id,
		data: {
			'_token' : $('input[name=_token').val()
		},
		success: function (data)
