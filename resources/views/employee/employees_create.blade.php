...
<div class = "row">
  <div class = "panel default-panel">
   <div class = "panel-heading">
    <h3><img src="/images/bar.png"> Employee | New Employee</h3>
    <hr />
  </div>
 ...
 <div class="panel-body">
  <div class = "tab-content">
    ...
    <div class = "col-md-12">
      ...
      <div class = "panel-heading">
      <h4><small>3</small>&nbsp;&nbsp;Current Address</h4>
     </div>
     <div class = "form-group">
      <div class = "col-md-12">
        <div class = "col-md-5">
...
<div class = "panel-heading">
      <h4><small>4</small>&nbsp;&nbsp;Other Information</h4>
     </div>
...
<script>
  ...
  $(document).ready(function(){
    ...
    Inputmask("9{3}-9{2}-9{2}").mask($("#emergencyContact"));
