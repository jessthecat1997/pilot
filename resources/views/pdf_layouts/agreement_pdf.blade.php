...
<body>
	...
	<div style="text-align:justify-all">
		...
		<p>
			8.	As an added security measure, the <strong>SECOND PARTY</strong> shall provide any and all trucks deplyed to the <strong>FIRST PARTY</strong> with sufficient communication equipment such as cellular phones and GPS.
		</p>
		<p>
			9.	All repairs and maintenance expenses of the trucks shall be for the account of the <strong>SECOND PARTY</strong>. Toll fees, parking fees and other related expenses shall likewise be shouldered by the <strong>SECOND PARTY</strong>.
		</p>
		<p>
			10.	For its services, the <strong>FIRST PARTY</strong> shall accordingly pay the sum equivalent to the agreed rates on a per trip, per truck basis to the <strong>SECOND PARTY</strong> as stipulated in <strong>ANNEX"A"</strong>. Demurrage fees may be agreed upon by the parties.
		</p>
		<p>
			11.	The <strong>SECOND PARTY</strong> shall not effect any increase in trucking rate unless the same has been mutually agreed upon by both parties. Provided, however, that such agreement has been reduced to the writing prior to the effectivity of said increase.
		</p>
		<p>
			12.	Payment shall be made by the <strong>FIRST PARTY</strong> to the <strong>SECOND PARTY</strong> within Fifteen (15) days upon receipt of the billing statement. The billing statement shall be submitted by the <strong>SECOND PARTY</strong> within three (3) working days after rendition of service. Otherwise, a 5% penalty of the total billing will be imposed in case of late billings. If the <strong>SECOND PARTY</strong> already violated the 3rd time, 10% penalty will be imposed.
		</p>
		<p>
