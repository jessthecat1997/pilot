...
<button class = "btn btn-md btn-primary ConfirmBut" style="width: 100%;">Create Brokerage Service Order</button>
</div>
</div>
...
error: function(data) {
  ...
  $('.ConfirmBut').on('click', function(e){
