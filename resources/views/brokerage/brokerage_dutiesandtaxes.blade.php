    ...
    <form class="form">
      ...
      <label>Expected Arrival Date*</label>
       <div class = "input-group">
        ...
        <span class="input-group-btn"><button class="btn btn-default" type="button" onclick="getData()" id = "arrivalDateButton"><i class="fa fa-calendar "></i></button></span>
      </div>
    </div>
    <div class="form-group">
      <label>*Amount</label>
     ...
     <div class = "form-group">
       ...
       <div class="col-md-5">
        <div class="input-group">
         ...
         <div class="input-group-btn">
          <button type="button" class="btn btn-default" aria-expanded="false">kgs</button>
        </div>
      </div>
    </div>
  </div>
