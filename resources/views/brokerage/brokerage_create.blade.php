...
<div class="container-fluid">
	<div class="row">
		<div class = "panel-heading">
			<h4><small>1</small>&nbsp;Consignee Information</h4>
		</div>
					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div class = "pull-right">
								<a class = "btn but btn-md" onclick="$('#ConsigneeModal').modal('show');"> New Consignee</a>
							</div>
							<br/>
							<br/>
							<br/>
	...
	<div class="row">
		...
		<div class="panel-heading" id="heading">Service Order Details</div>
		<div class="panel-body">
			<div class = "col-md-12">
				...
				<div class="form-group">
					...
					<label class = "col-md-12 control-label">
						<button  class="btn but" id = "generateDAT">
