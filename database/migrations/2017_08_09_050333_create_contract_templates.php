    ...
    public function up()
    {
        ...
        ->insert(
            array(
                ...
                0 For its services, the FIRST PARTY shall accordingly pay the sum equivalent to the agreed rates on a per trip, per truck basis to the SECOND PARTY as stipulated in ANNEX"A". Demurrage fees may be agreed upon by the parties. <br/> 
                1 The SECOND PARTY shall not affect any increase in trucking rate unless the same has been mutually agreed upon by both parties. Provided, however, that such agreement has been reduced to the writing prior to the effectivity of said increase. <br/> 
                2 Payment shall be made by the FIRST PARTY to the SECOND PARTY within Fifteen (15) days upon receipt of the billing statement. The billing statement shall be submitted by the SECOND PARTY within three (3) working days after rendition of service. Otherwise, a 5% penalty of the total billing will be imposed in case of late billings. If the SECOND PARTY already violated the 3rd time, 10% penalty will be imposed. <br/> 
                3 The SECOND PARTY shall be held accountable in cases of loss and damage to the cargo of the FIRST PARTY under any and all circumstances while the same under the custody of the SECOND PARTY. In this regard, the SECOND PARTY is required to obtain an Insurance Coverage, with a limit of Php 5,000,000.00 (Five Million Pesos) per accident to cover FIRST PARTYs shipments with an insurance company acceptable to the <strong>FIRST PARTY attached herewith as <strong>ANNEX B
                ...
                Should SECOND PARTY be at the fault, FIRST PARTY shall likewise have the right to make either arrangements with the respect to the work or services to be performed including the right to immediately recover expenses and costs from the SECOND PARTYs bond.<br/>
                
                4 The FIRST PARTY reserves the right to offset the amount of any documented loss or damage sustained by the FIRST PARTY from any unpaid invoice of the SECOND PARTY. Likewise, chassis units allowed by Nippon to be used by subcontractor shall be maintained and accounted for by the trucker. any loss or damage shall be charged to the SECOND PARTY. Provided, that no such accountibility shall attach until both the FIRST PARTY and the SECOND PARTY shall have conducted and investigation and agreed on the existence of such intentional/negligent acts.<br/>
                
                5 During the course of this Agreement, either party may have access to one other s confidential information and materials. Both parties may agree to maintain any and all such informations in confidence and to take all measures to prevent unauthorized disclosure. A breach of this confidentiality shall be a ground for automatic termination of this Agreement and cause for the filing of a civil suit for damages.
                
                The provisions of this Section shall survive the expiration or termination of this Agreement for a period of two (2) years.<br/>
                
                6 The SECOND PARTY undertakes not to give any rebate, commission, cash gift or any gift of value to any FIRST PARTY s employees. Should such violation take place, this agreement shall be automatically voided. Not included in this prohibition, the Human Resource Department or Office of the President, on the occasion of a company celebration.<br/>
                
                7 This agreement shall take effect for a period of <u></u> commencing on <u></u> and ending on <u></u>. Renewal of the agreement will partly depend on the SECOND PARTY s services, which will be undertaken by the FIRST PARTY periodically.<br/>
                
                8. The FIRST PARTY reserves the right total terminate the contract by reason of the violation of any provision of this agreement or whenever it determines that the services of the SECOND PARTY no longer satisfactory meets its requirements, as well as when business condition so dedicated.
                
                The parties shall consult each other in good faith and shall exhaust all available remedies to settle any and all disputes or disagreements arising out of or relating the validity, interpretation, enforceablity, or performance under this Agreement. In case of failure to resolve the dispute and their joint decision shall be binding upon the reached between the two parties within fifteen (15) days from their initial meeting, the parties shall resort to arbitration as provided in Republic Act No.9285.<br/>
                
                9. This contract shall be construed, interpreted and governed by the laws of the Philippines. Venue of any court action instituted for the purpose of any enforcing any right or obligation or other  means of resolution shall be exclusively laid in the courts of the Philippines.<br/>
