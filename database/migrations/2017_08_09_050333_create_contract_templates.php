    ...
    public function up()
    {
        ...
        ->insert(
            array(
                ...
                extinguisher, nylon ropes, flashlights, standard tool kit, etc.<br/> 8. As an added security measure, the SECOND PARTY shall provide any and all trucks deployed to the FIRST PARTY with sufficient communication equipment such as cellular phones and GPS.<br/> 9. All repairs and maintenance expenses of the trucks shall be for the account of the SECOND PARTY. Toll fees, parking fees and other related expenses shall likewise be shouldered by the SECOND PARTY.<br/> 10 For its services, the FIRST PARTY shall accordingly pay the sum equivalent to the agreed rates on a per trip, per truck basis to the SECOND PARTY as stipulated in ANNEX"A". Demurrage fees may be agreed upon by the parties.<br/> 11. The SECOND PARTY shall not affect any increase in trucking rate unless the same has been mutually agreed upon by both parties. Provided, however, that such agreement has been reduced to the writing prior to the effectivity of said increase. <br/>12. Payment shall be made by the FIRST PARTY to the SECOND PARTY within Fifteen (15) days upon receipt of the billing statement. The billing statement shall be submitted by the SECOND PARTY within three (3) working days after rendition of service. Otherwise, a 5% penalty of the total billing will be imposed in case of late billings. If the SECOND PARTY already violated the 3rd time, 10% penalty will be imposed. <br/> 13. The SECOND PARTY shall be held accountable in cases of loss and damage to the cargo of the FIRST PARTY under any and all circumstances while the same under the custody of the SECOND PARTY. In this regard, the SECOND PARTY is required to obtain an Insurance Coverage, with a limit of Php 5,000,000.00 (Five Million Pesos) per accident to cover FIRST PARTYs shipments with an insurance company acceptable to the FIRST PARTY attached herewith as ANNEX B 
